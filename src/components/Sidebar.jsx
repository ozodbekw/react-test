...
function Sidebar() {
  ...
  return (
    <div className=" flex flex-col  py-10 px-0 pl-8 hidden w-64 shrink-0 flex-col  bg-opacity-50 p-2 pr-0 pt-10  lg:flex">
      <div className="mb-20 flex flex-col font-semibold text-xl items-center">
        <img className="w-20 h-20 mb-3 rounded-full" src="./image.jpg" alt="" />
        <h2 className="text-xl font-semibold">Hello, akhror work1</h2>
      </div>
